...
const hobbySeed = [
  {
    ...
    snapshot: [
      ...
      },
      {
        label: "回復",
        value: "15分",
        note: "給水、補給、ストレッチを固定化して翌日に疲れを残しにくくする。"
      }
    ],
    tags: ["運動", "健康", "記録"],
    ...
    focusTable: [
      ...
      {
        theme: "回復",
        current: "走後の給水とストレッチを必ず行う。",
        signal: "睡眠メモまで残すと翌日の重さとの相関が見えやすい。",
        nextAction: "回復ルーティンに睡眠メモの欄を追加する。"
      }
    ],
    innovationIdeas: [
      {
      ...
      {
        title: "回復の見える化カード",
        combination: "ラン後記録 x 睡眠メモ",
        summary: "運動量よりも翌日への影響を軸に、続けやすい負荷を判断できるようにする。"
      }
    ],
    draftAngles: [
      "気温別に走りやすかったルートの比較",
      "シューズを替えた日の感覚メモの残し方",
      "疲労が抜けやすかった回復ルーティンの順番"
    ],
    firstReleaseItems: [
      "よく走るコース3本の紹介",
      "今使っているシューズの短評",
